...
// context (valgfritt) videresendes rått til Sentry. F50-kontrakt: kallstedet
// sender kun ikke-sensitive felt, f.eks. { extra: { url, method, reqId, rolle } }
// — aldri body/headers/cookies (PII).
